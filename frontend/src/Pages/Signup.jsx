        ...
        <div className="flex flex-col md:flex-row w-full h-screen">
            <div className=" h-screen w-full flex justify-center items-center bg-stone-100 p-4">
                <div className="w-full max-w-md p-4 md:p-8 rounded-lg"> 
                    ...
                    <SubHeading label={"Enter your information to create new Account"}></SubHeading>
                    <Inputbox label={"First Name"} placeholder={"Aman"} onchange={(e)=>{setFirstName(e.target.value)}}></Inputbox>
                    <Inputbox label={"Last Name"} placeholder={"Jain"} onchange={(e)=>{setLastName(e.target.value)}}></Inputbox>
