...
export const SendMoney = () => {
    ...
    return <div class="flex justify-center h-screen bg-cyan-200">
        <div className="h-full flex flex-col justify-center">
            ...
            >
                ...
                <div class="space-y-4">
                    ...
                    }} class="justify-center rounded-md text-lg font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white">
                        Initiate Transfer
                    </button>
                </div>
                </div>
